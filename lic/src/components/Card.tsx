...
const Card: React.FC<CardProps> = ({ image }: CardProps) => {
  ...
  return (
    <motion.div
      className="relative  flex justify-center items-center  h-[300px] w-[200px] rounded-lg overflow-hidden m-5 bg-gray-400 hover:scale-110 transition-transform duration-300 ease-in-out shadow-2xl "
